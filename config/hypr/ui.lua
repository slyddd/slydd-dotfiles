...
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 1.21, spring = "easy", style = "slidevert" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 1.94, spring = "easy", style = "slidevert" })
